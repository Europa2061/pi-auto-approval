...
```bash
pi install git:github.com:Europa2061/pi-auto-review
```

安装固定版本：

```bash
pi install git:github.com:Europa2061/pi-auto-review@v0.1.0
```

只安装到当前项目：

```bash
pi install -l git:github.com:Europa2061/pi-auto-review
```
